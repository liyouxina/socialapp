...
public interface UserdetailsService {
    ...
    List<Userdetails> queryNear(String city, int offset, int limit);

    List<Userdetails> search(String content);
    /**
     * 新增数据
     *
     ...
     * @return 实例对象
     */
    R insertOrUpdate(String token, Userdetails userdetails);
}